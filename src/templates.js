/**
 * Default blank template + exam profile definitions (content layer).
 */
(function (ET) {
  "use strict";
  ...
  /** Built-in fallback when fetch of exams/g11-functions/exam-data.json is unavailable (file://). */
  ...
  ET.getProfileById = function (id) {
    return ET.EXAM_PROFILES.find((p) => p.id === id) || ET.EXAM_PROFILES[0];
  };
})(window.ExamToolkit);
