...
(function (ET) {
  ...
  ET.I18N = {
    en: {
      ...
      "field.keepHeadingWithFirstQuestion": "Keep heading with first question",
      "field.breakInside": "Page break inside question",
      "field.keepQuestionOnOnePage": "Keep question on one page",
      "field.allowSplitAcrossPages": "Allow split across pages",
      "button.addPageBreak": "Add Page Break",
      "label.manualPageBreak": "Manual Page Break",
      "label.pageBreak": "Page Break",
      "help.pageBreakBefore": "Start a new printed page before this part or question.",
      "help.breakInsideAvoid": "Try to keep the entire question on one page when printing.",
      "help.manualPageBreak": "Inserts a manual page break in print preview. Not numbered or scored.",
      "field.marks": "Marks",
      "field.type": "Type",
      ...
      "questionType.page-break": "Page Break",
      ...
      "validation.invalidPageBreakBefore": "{path}: pageBreakBefore should be boolean",
      "validation.invalidKeepHeadingWithFirstQuestion": "{path}: keepHeadingWithFirstQuestion should be boolean",
      "validation.invalidBreakInside": "{path}: breakInside must be \"avoid\" or \"auto\"",
      "validation.pageBreakNonZeroMarks": "{path}: page-break should have 0 marks",
      ...
      "toast.pageBreakAdded": "Page break added",
    ...
    zh: {
      ...
      "field.pageBreakBefore": "此处前分页",
      "field.keepHeadingWithFirstQuestion": "标题与第一题尽量同页",
      "field.breakInside": "题目内分页",
      "field.keepQuestionOnOnePage": "题目尽量不跨页",
      "field.allowSplitAcrossPages": "允许题目跨页",
      "button.addPageBreak": "添加分页符",
      "label.manualPageBreak": "手动分页符",
      "label.pageBreak": "分页符",
      "help.pageBreakBefore": "打印时在此部分或题目前开始新页。",
      "help.breakInsideAvoid": "打印时尽量将整个题目保留在同一页。",
      "help.manualPageBreak": "在预览中插入手动分页符，不参与编号与计分。",
      "field.marks": "分值",
      "field.type": "题型",
      ...
      "validation.invalidPageBreakBefore": "{path}：pageBreakBefore 应为布尔值",
      "validation.invalidKeepHeadingWithFirstQuestion": "{path}：keepHeadingWithFirstQuestion 应为布尔值",
      "validation.invalidBreakInside": "{path}：breakInside 必须为 avoid 或 auto",
      "validation.pageBreakNonZeroMarks": "{path}：page-break 分值应为 0",
