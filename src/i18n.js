...
(function (ET) {
  ...
  ET.I18N = {
    en: {
      ...
      "toolbar.saveAsFolder": "Save As Folder",
      ...
      "toast.savedToFolder": "Saved to selected folder",
      "toast.saveFolderCancelled": "Save cancelled",
      "toast.saveFolderUnsupported": "Folder saving is not supported. Use Export JSON instead.",
      "toast.saveFolderFailed": "Save failed",
    ...
    zh: {
      ...
      "toast.savedToFolder": "已保存到所选文件夹",
      "toast.saveFolderCancelled": "已取消保存",
      "toast.saveFolderUnsupported": "当前浏览器不支持直接保存到文件夹，请使用导出 JSON。",
      "toast.saveFolderFailed": "保存失败",
